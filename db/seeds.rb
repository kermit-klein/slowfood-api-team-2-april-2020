...
food9 = MenuItem.create(name: 'Ice-cream', description: 'It will soft serve', price: 33, category: 3)
food10 = MenuItem.create(name: 'Deep fried grapes on a donut', description: 'Donut ask', price: 33, category: 3)
food11 = MenuItem.create(name: 'Major naise', description: 'Fatty and slightly good', price: 5, category: 4)
food12 = MenuItem.create(name: 'Extra fries', description: 'Fatty golden potato fingers', price: 25, category: 4)
food1 = MenuItem.create(name: 'Pickled Egg', description: 'An egg that is in a reeeeal pickle!', price: 69, category: 0)
food2 = MenuItem.create(name: 'Bread', description: 'Simply bread', price: 25, category: 0)
food3 = MenuItem.create(name: 'Ham Sandwich', description: 'No, not hamBURGER, ham SANDWICH', price: 42, category: 1)
food4 = MenuItem.create(name: 'Pizza', description: 'Better than Dominos Pizza', price: 50, category: 1)
